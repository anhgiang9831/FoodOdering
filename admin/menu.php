					...
					<div class="card-body">
							...
							<div class="form-group">
								<div class="custom-control custom-switch">
								  ...
								  <label class="custom-control-label" for="availability">Có sẵn</label>
								</div>
							</div>	
							<div class="form-group">
								<label class="control-label">Loại thực đơn </label>
							...
							<div class="form-group">
								...
								<input type="number" placeholder="VNĐ" class="form-control text-right" name="price" step="any">
							</div>
							<div class="form-group">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								...
								<button class="btn btn-sm btn-default col-sm-3" type="button" onclick="$('#manage-menu').get(0).reset()"> Hủy</button>
							</div>
						</div>
					</div>
				</div>
